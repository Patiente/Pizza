...
function calctotalPrice(e) {
    ...
    alert("Your order of " + getNumber() + " pizzas has been processed.Your total amount payable is " + totalPrice +" RWF." )
}
...
$(document).ready(function () {
    $("#delivery-info").submit(function () {
        ...
        alert("Hello " + name + ". Thank you for chosing The perfect Pizza. Your order has been successfully received and will be delivered to " +  location + ".The delivery will cost 1000RWF. We will call you shortly on " + number);
    }); 
});